 ...
 * @author pascal
 */
public class JIFMedia extends javax.swing.JInternalFrame {
...
//            icn = DriverManager.getConnection(lsDSN, "root", "");
    ...
    private void initComponents() {
        ...
        jTableMedia.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jTableMedia.setGridColor(new java.awt.Color(0, 0, 0));
...
//                }
    ...
    private void jButtonValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonValiderActionPerformed
        ...
        try {
            ...
            remplirJTable();
            System.out.println("Validations exécutées");
        } catch (SQLException e) {
            try {
                icn.rollback();
                System.out.println("Rollback");
            } catch (SQLException ex) {
                //Logger.getLogger(JIFMedia.class.getName()).log(Level.SEVERE, null, ex);
                System.out.println("Rollback KO");
            }
        }
